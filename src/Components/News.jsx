...
const News =()=> {
  ...
  return (
   <>
    ...
    <div className="hover:bg-white text-3xl bg-gray-400 text-black py-4 text-center">latest news</div>
    <div  className=" py-4 grid sm:gap-4  sm:grid-cols-3 bg-black object-fit ">
    {news.map((data,i) => {
            return (
                <div  key={i} className='bg-gray-800 hover:scale-110 duration-500 rounded-sm  m-4 '  >
                <div >
